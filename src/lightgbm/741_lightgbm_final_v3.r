...
kdataset       <- "./datasets/paquete_premium_ext_721_v_lag1_2.csv.gz"
...
klambda_l2	   <- 0
kmax_bin	   <- 31
knum_iterations	   <- 1137
klearning_rate     <- 0.0100778444371077
kfeature_fraction  <- 0.2065357998751
kmin_data_in_leaf  <- 17626
knum_leaves	   <- 1320
kprob_corte	   <- 0.0155539146870707
