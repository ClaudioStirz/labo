...
kdataset       <- "./datasets/paquete_premium_ext_721_v_lag2.csv.gz"
...
klambda_l2	   <- 0
kmax_bin	   <- 31
knum_iterations	   <- 1116
klearning_rate     <- 0.0101008560953821
kfeature_fraction  <- 0.998621255103438
kmin_data_in_leaf  <- 13208
knum_leaves	   <- 1432
kprob_corte	   <- 0.014157818210832
