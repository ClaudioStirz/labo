...
param  <- list( "num.trees"=       500,  #cantidad de arboles
                "mtry"=             NULL,#30,  #cantidad de variables que evalua para hacer un split  sqrt(ncol(dtrain))
                "min.node.size"=  NULL,  #tamaño minimo de las hojas
                "max.depth"=        NULL#12   # 0 significa profundidad infinita
              )

#set.seed(102191) #Establezco la semilla aleatoria
set.seed(999233) #Establezco la semilla aleatoria
