...
hs  <- makeParamSet(
          makeIntegerParam("num.trees" ,        lower=  350L, upper= 450L),  #la letra L al final significa ENTERO
          makeIntegerParam("max.depth",         lower=    5L, upper=   15L),  # 0 significa profundidad infinita
          makeIntegerParam("min.node.size" ,    lower=    70L, upper=  90L),
          makeIntegerParam("mtry" ,             lower=    6L, upper=   10L))
...
setwd("C:\\Users\\Administrador\\Desktop\\UTNFRP\\AplicacionesaEconomiayFinanzas\\Laboratorio\\")   #Establezco el Working Directory
...
setwd("C:\\Users\\Administrador\\Desktop\\UTNFRP\\AplicacionesaEconomiayFinanzas\\Laboratorio\\labo\\exp\\HT4330\\")   #Establezco el Working Directory DEL EXPERIMENTO
