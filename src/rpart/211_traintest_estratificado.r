...
setwd("C:\\Utiles\\UTNFRP\\EconomiayFinanzas\\Laboratorio\\")   #Establezco el Working Directory
#cargo los datos

dataset  <- fread("./datasets/paquete_premium_202011.csv")

#particiono estratificadamente el dataset
particionar( dataset, division=c(50,50), agrupa="clase_ternaria", seed= 999307 )  #Cambiar por la primer semilla de cada uno !
