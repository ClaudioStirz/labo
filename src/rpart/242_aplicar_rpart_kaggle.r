...
param_basicos  <- list( "cp"=          -0.599,  #complejidad minima
                        "minsplit"=   1730,     #minima cantidad de registros en un nodo para hacer el split
                        "minbucket"=  669,     #minima cantidad de registros en una hoja
